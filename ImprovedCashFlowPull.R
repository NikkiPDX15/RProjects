...
Grant_Rebates1[Grant_Rebates1 == 0]<- NA
Grant_Rebates2[Grant_Rebates2 == 0]<- NA


Lease_Payments1[Lease_Payments1 == 0]<- NA
Lease_Payments2[Lease_Payments2 == 0]<- NA

SLB_Proceeds1[SLB_Proceeds1 == 0]<- NA
SLB_Proceeds2[SLB_Proceeds2 == 0]<- NA

SREC_Rev1[SREC_Rev1 == 0]<- NA
SREC_Rev2[SREC_Rev2 == 0]<- NA

Property_Tax1[Property_Tax1 == 0]<- NA
Property_Tax2[Property_Tax2 == 0]<- NA

Site_Lease1[Site_Lease1 == 0]<- NA
Site_Lease2[Site_Lease2 == 0]<- NA
